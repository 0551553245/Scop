...
export default function AdminLogin() {
  ...
  const t = {
    en: {
      ...
      tagline:     'Platform\nManagement',
      sub:         'Manage every restaurant, subscription and owner account on Scop.',
      heading:     'Admin sign in',
      subheading:  'Restricted to platform administrators',
      emailLabel:  'Email address',
      emailPh:     'admin@scop.com',
      passLabel:   'Password',
      passPh:      '••••••••',
      signin:      'Sign in',
      ...
      errRole:     'This account does not have admin access.',
    ...
    ar: {
      ...
      portal:      'بوابة المشرف العام',
      tagline:     'إدارة\nالمنصة',
      sub:         'أدر كل مطعم واشتراك وحساب مالك على سكوب.',
      heading:     'تسجيل دخول المشرف',
      subheading:  'مخصص لمشرفي المنصة فقط',
      ...
      errRole:     'هذا الحساب لا يملك صلاحية الإشراف.',
